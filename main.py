...
parser.add_argument('--lr', default=0.05, type=float, help='learning rate 0.05')
...
# optimizer = Adamax(net.parameters(), lr=0.002, betas=(0.9, 0.999), eps=1e-08, weight_decay=1e-5)
